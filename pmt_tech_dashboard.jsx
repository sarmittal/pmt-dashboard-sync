...
// Replace with your actual webhook URL after setting up GitHub Actions
// Format: https://api.github.com/repos/YOUR_USERNAME/YOUR_REPO/dispatches
const GITHUB_WEBHOOK_URL = "YOUR_GITHUB_WEBHOOK_URL";
const GITHUB_TOKEN       = "YOUR_GITHUB_PAT_TOKEN"; // Personal Access Token with repo scope
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
              ...
              {!syncMeta && !wp && !raid && !req && (
                <span style={{ fontSize:11, color:C.gold }}>⚠ No data loaded — run the sync script or upload files manually</span>
              )}
            </div>
            ...
            <div style={{ display:"flex", gap:8, alignItems:"center", flexWrap:"wrap" }}>
              ...
              <button
                onClick={async () => {
                  if (GITHUB_WEBHOOK_URL === "YOUR_GITHUB_WEBHOOK_URL") {
                    alert("GitHub webhook not configured yet.\n\nTo enable live refresh:\n1. Set up GitHub Actions (see setup guide)\n2. Replace YOUR_GITHUB_WEBHOOK_URL in the dashboard code");
                    return;
                  }
                  setRefreshing(true);
                  try {
                    const r = await fetch(GITHUB_WEBHOOK_URL, {
                      method: "POST",
                      headers: { "Authorization": `Bearer ${GITHUB_TOKEN}`, "Accept": "application/vnd.github+json", "Content-Type": "application/json" },
                      body: JSON.stringify({ event_type: "refresh-dashboard" }),
                    });
                    if (r.ok) {
                      alert("✅ Refresh triggered! Data will update in ~30 seconds.\n\nThe page will reload automatically.");
